 ...
 * @author woemler
 */
@ModelRepository(DataSet.class)
public class DataSetRepository extends GenericMongoRepository<DataSet, String> 
		implements DataSetMetadataRepository<DataSet, String> {
