 ...
 * @author woemler
 */
public interface EntrezGeneRepository extends CustomGeneRepository,
	...
	@Query("select g from EntrezGene g join g.aliases a where a.name = ?1")
	List<EntrezGene> findByAliases(String alias);
}
