...
@ContextConfiguration(classes = {
		...
		GenericServiceConfig.class, ParameterControllerConfig.class})
@WebAppConfiguration
@FixMethodOrder
public class QueryParameterControllerTests {
	...
	public void findAll() throws Exception {
		mockMvc.perform(get("/param/genes").accept(HalMediaType.APPLICATION_JSON_HAL_VALUE))
	...
	public void findAllWithoutLinks() throws Exception {
		mockMvc.perform(get("/param/genes"))
				.andExpect(status().isOk())
	...
	public void findFiltered() throws Exception {
		mockMvc.perform(get("/param/genes?exclude=links,primaryGeneSymbol").accept(
	...
	public void findFieldFiltered() throws Exception {
		mockMvc.perform(get("/param/genes?fields=links,primaryGeneSymbol").accept(
				HalMediaType.APPLICATION_JSON_HAL_VALUE))
				.andExpect(status().isOk())
				.andExpect(jsonPath("$", hasKey("content")))
				.andExpect(jsonPath("$.content", hasSize(5)))
	...
	public void findMultipleByParams() throws Exception {
		mockMvc.perform(get("/param/genes?geneType=pseudo").accept(HalMediaType.APPLICATION_JSON_HAL_VALUE))
				.andExpect(status().isOk())
				.andExpect(jsonPath("$", hasKey("content")))
	...
	public void findByAlias() throws Exception {
		mockMvc.perform(get("/param/genes?alias=MNO").accept(MediaType.APPLICATION_JSON))
				.andExpect(status().isOk())
	...
	public void findByKeyValueAttributes() throws Exception {
		mockMvc.perform(get("/param/genes?attribute=isKinase:Y").accept(MediaType.APPLICATION_JSON))
				.andExpect(status().isOk())
	...
	public void findPaged() throws Exception {
		mockMvc.perform(get("/param/genes?page=1&size=3").accept(HalMediaType.APPLICATION_JSON_HAL_VALUE))
				.andExpect(status().isOk())
				.andExpect(jsonPath("$", hasKey("content")))
				.andExpect(jsonPath("$.content", hasSize(2)))
				.andExpect(jsonPath("$.content[0]", hasKey("entrezGeneId")))
	...
	public void findPagedWithoutLinks() throws Exception {
		mockMvc.perform(get("/param/genes?page=1&size=3"))
				.andExpect(status().isOk())
				.andExpect(jsonPath("$", hasKey("content")))
				.andExpect(jsonPath("$.content", hasSize(2)))
				.andExpect(jsonPath("$.content[0]", hasKey("entrezGeneId")))
	...
	public void findSorted() throws Exception {
		mockMvc.perform(get("/param/genes?sort=primaryGeneSymbol,desc").accept(
				HalMediaType.APPLICATION_JSON_HAL_VALUE))
				.andExpect(status().isOk())
				.andExpect(jsonPath("$", hasKey("content")))
				.andExpect(jsonPath("$.content", hasSize(5)))
