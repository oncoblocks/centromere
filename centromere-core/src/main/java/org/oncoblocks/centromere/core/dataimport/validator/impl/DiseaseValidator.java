...
import org.oncoblocks.centromere.core.model.support.DiseaseDto;
import org.springframework.util.Assert;

/**
 * @author woemler
 */
public class DiseaseValidator implements EntityValidator<DiseaseDto> {
	@Override 
	public boolean validate(DiseaseDto entity) {
		try {
			...
			Assert.notNull(entity.getMeshId());
			Assert.isTrue(!entity.getMeshId().equals(""));
			return true;
