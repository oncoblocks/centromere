 ...
 *   basic parameter types, annotated with {@link QueryParameter} to add extra customization to the 
...
public class AnnotatedQueryParameters implements QueryParameters {
	...
	/**
	 * Remaps parameter names by inspecting attributes with {@link QueryParameter} annotations and 
	...
	/**
	 * Converts a {@link AnnotatedQueryParameters} object into
	 ...
	 * @return
	 */
	public static List<QueryCriteria> toQueryCriteria(AnnotatedQueryParameters queryParameters){
