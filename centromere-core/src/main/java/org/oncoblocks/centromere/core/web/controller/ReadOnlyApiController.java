...
import org.oncoblocks.centromere.core.web.exceptions.MethodNotAllowedException;
...
/**
 * Extension of {@link org.oncoblocks.centromere.core.web.controller.BaseApiController} that 
 *   throws a {@link org.oncoblocks.centromere.core.web.exceptions.MethodNotAllowedException} when
...
public class ReadOnlyApiController<
		...
		Q extends AnnotatedQueryParameters> extends BaseApiController<T, ID, Q>  {
