...
import org.oncoblocks.centromere.core.model.support.SubjectDto;
import org.springframework.util.Assert;

/**
 * @author woemler
 */
public class SubjectValidator implements EntityValidator<SubjectDto> {
	@Override 
	public boolean validate(SubjectDto entity) {
		try {
			...
			Assert.notNull(entity.getSpecies());
			Assert.isTrue(!entity.getSpecies().equals(""));
			Assert.notNull(entity.getGender());
			Assert.isTrue(!entity.getGender().equals(""));
			return true;
