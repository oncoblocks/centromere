 ...
 * @author woemler
 */
public class TestApiController<T extends Model<Long>> {
	
	private RepositoryOperations<T, Long> repository;

	public TestApiController(RepositoryOperations<T, Long> repository) {
