...
public class OptionsEndpointDescriptor {
	...
	private org.oncoblocks.centromere.web.query.AnnotatedQueryParameters parameters;
	...
	public OptionsEndpointDescriptor(HttpMethod method, String url,
			...
			org.oncoblocks.centromere.web.query.AnnotatedQueryParameters parameters, Object response, List<HttpStatus> statuses) {
		this.method = method;
		this.url = url;
	...
	public org.oncoblocks.centromere.web.query.AnnotatedQueryParameters getParameters() {
		return parameters;
	}

	public void setParameters(org.oncoblocks.centromere.web.query.AnnotatedQueryParameters parameters) {
		this.parameters = parameters;
	}
